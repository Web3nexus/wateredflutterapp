      ...
      if (time != null && mounted) {
          ...
          await showDialog(
              ...
              builder: (context) => AlertDialog(
                  ...
                  content: TextField(controller: titleController, decoration: const InputDecoration(hintText: 'e.g. Morning Ritual')),
                  actions: [
                      ...
                      TextButton(
                          onPressed: () async {
                              ...
                              if (titleController.text.isNotEmpty) {
                                  await ref.read(reminderServiceProvider).saveReminder(titleController.text, time, ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']); // Default daily
                  ...
                  child: Row(
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (val) async {
                            await ref.read(reminderServiceProvider).updateReminder(reminder.id!, val);
                            ref.refresh(remindersListProvider);
                        },
                      ),
                    ],
